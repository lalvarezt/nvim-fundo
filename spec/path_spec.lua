...
describe('path module.', function()
    ...
    describe('normalize', function()
        describe('on Unix,', function()
            ...
            it([[root path remains root.]], function()
            ...
            it([[relative parent paths preserve unresolved parents.]], function()
                assert.equal('../..', path.normalize('../..'))
                assert.equal('../../x', path.normalize('../../x'))
                assert.equal('../b', path.normalize('a/../../b'))
            end)
            it([[absolute parent paths stop at root.]], function()
                assert.equal('/', path.normalize('/..'))
                assert.equal('/b', path.normalize('/a/../../b'))
            end)
        end)
        describe('on Windows', function()
            ...
            it([[absolute parent paths stop at drive root.]], function()
                assert.equal([[C:\]], path.normalize([[C:\..]]))
                assert.equal([[C:\b]], path.normalize([[C:\a\..\..\b]]))
            end)
        end)
    end)
    describe('join', function()
        describe('on Unix,', function()
            ...
            it('joins absolute segments without duplicating separators.', function()
